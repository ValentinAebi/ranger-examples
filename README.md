...
|[Mergesort](https://github.com/TheAlgorithms/Java/blob/master/src/main/java/com/thealgorithms/sorts/MergeSort.java)                   |[🟡 (1x `!!`)](./licorne/mergesort/MergeSort.lic)                 |[🟡 (3x `@AssumeAssertion`)](./java-checker-framework/src/main/java/org/example/sorting/MergeSort.java)                                  |[❌](./liquid-java/src/main/java/sorting/MergeSort.java)         | [✔](./scala/src/main/scala/sorting/MergeSort.scala)             |
