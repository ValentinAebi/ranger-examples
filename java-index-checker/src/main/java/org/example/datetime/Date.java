...
record Date(int year, @IntRange(from = 1, to = 12) int month, @IntRange(from = 1, to = 31) int day) {
    ...
    public static @IntRange(from = 28, to = 31) int nDaysInMonth(int year, int month) {
        if (month == 2) {
            // slightly simplified...
            return year % 4 != 0 ? 28
                    : year % 100 != 0 ? 29
